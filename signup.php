                    ...
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            <form action="#" method="post">
                                ...
                                <input class="form-control" type="email" name="email" placeholder="EmailId">
                                <input class="form-control" type="password" name="password" placeholder="Enter Password">
                                <input class="form-control" type="repassword" name="retype" placeholder="Retype Password">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <select class="form-control">
                                            ...
                                            <option value="1940">1940</option><option>
                                        </select>
                                    </div>
                                </div>
                                <br>
